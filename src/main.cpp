...
void setup()
{
  // FastLED.addLeds<SK9822, CLOCKPIN, DATAPIN, BGR>(leds, NUMPIXELS);   // SK9822 strips
  // 12v WS2815 strip 
  // FastLED.addLeds<WS2811, CLOCKPIN, GRB>(leds, 450);  // 15m; strobo-crazy, even 1 roll (5m)
  FastLED.addLeds<WS2811, CLOCKPIN, GRB>(leds, NUMPIXELS);  // 5m
  Serial.begin(57600);
